...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "murmur3.autotvin.dat"
	set constFileTvOut       "murmur3.autotvout.dat"
	set constFileHdlTvIn     "murmur3.autohdltvin.dat"
	set constFileHdlTvOut    "murmur3.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
