...
$(ObjDir)/murmur3_tb.c_pre.c.tb.o : murmur3_tb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) murmur3_tb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/murmur3.c_pre.c.tb.o : murmur3.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) murmur3.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
