...
#define AUTOTB_TVIN_key  "../tv/cdatafile/c.murmur3.autotvin_key.dat"
// wrapc file define: "seed"
#define AUTOTB_TVIN_seed  "../tv/cdatafile/c.murmur3.autotvin_seed.dat"
// wrapc file define: "ap_return"
#define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.murmur3.autotvout_ap_return.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "ap_return"
#define AUTOTB_TVOUT_PC_ap_return  "../tv/rtldatafile/rtl.murmur3.autotvout_ap_return.dat"
...
extern "C" unsigned int murmur3 (
int key,
int seed);

extern "C" unsigned int AESL_WRAP_murmur3 (
int key,
int seed)
{
	...
	else
	{
		...
		sc_bv<32> key_tvin_wrapc_buffer;
				...
				// celement: key(31, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						...
						if (&(key) != NULL) // check the null address if the c port is array or others
						{
							...
							key_tmp_mem = key;
							key_tvin_wrapc_buffer.range(31, 0) = key_tmp_mem.range(31, 0);
						}
					}
				}
			}
		...
		// [[transaction]]
		sprintf(tvin_seed, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_seed, tvin_seed);

		sc_bv<32> seed_tvin_wrapc_buffer;
			...
			// bitslice(31, 0)
			{
				// celement: seed(31, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						...
						// regulate_c_name       : seed
						// input_type_conversion : seed
						if (&(seed) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> seed_tmp_mem;
							seed_tmp_mem = seed;
							seed_tvin_wrapc_buffer.range(31, 0) = seed_tmp_mem.range(31, 0);
						}
					}
				}
			}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_seed, "%s\n", (seed_tvin_wrapc_buffer).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_seed, tvin_seed);
		}

		tcl_file.set_num(1, &tcl_file.seed_depth);
		sprintf(tvin_seed, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_seed, tvin_seed);

// [call_c_dut] ---------->

		CodeState = CALL_C_DUT;
		unsigned int AESL_return = murmur3(key, seed);
		...
		delete [] tvin_key;
		// release memory allocation: "seed"
		delete [] tvin_seed;
